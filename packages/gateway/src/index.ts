...
5. 可用的筛选维度：市值、交易量、持仓人数、聪明钱买入、鲸鱼异动、社交热度、meme叙事、价格趋势`;
    ...
    const formatRules = isTwitter
      ...
      : `IMPORTANT rules:\n1. Reply in the SAME language as the user's message.\n2. Use markdown tables and formatting.\n3. MUST include the FULL contract address (all 42 characters, NEVER abbreviate with ...).\n4. Include all available data: price, market cap, volume, holders, liquidity, buy/sell tax.\n5. NEVER fabricate numbers. If missing, skip that field.\n6. Match response length to user intent:\n   - Quick question ("XX怎么样", "查一下XX"): concise summary, key metrics in a small table, 1-2 sentences of advice. Under 150 words.\n   - Deep analysis ("详细分析XX", "深入介绍XX"): full report with sections (基本信息, 市场数据, 安全评估, 流动性, 持仓, 建议). Up to 500 words.\n   - Default to concise unless user asks for detail.`;
